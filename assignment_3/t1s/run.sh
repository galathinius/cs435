...
$SPARK_HOME/bin/spark-submit --class Ranking --deploy-mode client --supervise target/scala-2.12/simple-project_2.12-1.0.jar /inputReal/links-simple-sorted.txt /inputReal/titles-sorted.txt /outReal 
