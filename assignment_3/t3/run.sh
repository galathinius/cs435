...
$HADOOP_HOME/bin/hadoop fs -rm -r /outReal3
...
$SPARK_HOME/bin/spark-submit --class RankingBomb --deploy-mode client --supervise target/scala-2.12/simple-project_2.12-1.0.jar /input-mod/links-modified.txt /input-mod/titles-modified.txt /outReal3 

echo "Showing the output ..."
$HADOOP_HOME/bin/hadoop fs -cat /outReal3/*